...
public class Workshop2 {
    ...
    public static void teil1() {
        ...
        System.out.println(WHITE + "Imperativ: " + sum);
        ...
        Function<String, Integer> f = x -> x.replaceAll("a", "").length();
        sum = f.apply(myString);
        System.out.println("Funktional: " + sum);

        // c) (3 Punkte) Mit Streams:
        // ...
        sum = (int) myString.chars().filter(x -> x != 'a').count();
    ...
    public static void teil2() {
        ...
        System.out.println(WHITE + "Externe Iteration: " + sum);
        ...
        // ...
        sum = (int) myList.stream().filter(x -> x.equals(myString)).count();
        System.out.println("Streams: " + sum);
    }
    ...
    public static void teil3() {
        ...
        // ...
        mLst = sLst.stream().filter(x -> x.ewz() >= 1_000_000).sorted(Comparator.comparing(Stadt::ewz).reversed()).collect(Collectors.toList());
    ...
    public static void teil4() throws IOException {
        ...
        System.out.println("\n5 a)");
        BufferedReader in = new BufferedReader(new FileReader("/home/fabian/htwg/Prog2/src/workshop2/data/movies-top-grossing.txt"));
        // ...
        ...
        System.out.println("\n5 c)");
        in = new BufferedReader(new FileReader("/home/fabian/htwg/Prog2/src/workshop2/data/movies-top-grossing.txt"));
        // ...
        ...
        System.out.println("\n5 h)");
        // ...
        TreeMap<Integer, List<String>> map3 = movieList.stream().collect(
                Collectors.groupingBy(
                        Movie::year,
                        TreeMap::new,
                        Collectors.mapping(
                                Movie::title, Collectors.toList()
                        )
                ));
    ...
    public static void teil5() {
        ...
        int s = 973;
        // ...
        System.out.println("Startwert: " + s);
