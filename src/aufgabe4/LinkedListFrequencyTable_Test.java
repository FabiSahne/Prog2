...
public class LinkedListFrequencyTable_Test {
	...
	private static void test2() throws IOException {
		...
		LineNumberReader in;
		in = new LineNumberReader(new FileReader("/home/fabian/htwg/Prog2/Kafka_Der_Prozess.txt", StandardCharsets.UTF_8));
		String line;
		...
		// Ihr Code
		FrequencyTable<String> mostN = new LinkedListFrequencyTable<>();
		tab.collectNMostFrequent(100, mostN);
		System.out.println(mostN);
